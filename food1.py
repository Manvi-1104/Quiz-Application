...
def windowI():
    ...
    R1 = Radiobutton(window9, text="Jammu and Kashmir", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window9, text="Himachal Pradesh", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window9, text="Uttar Pradesh", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window9, text=" Punjab", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowH():
    ...
    R1 = Radiobutton(window8, text="USA", font=("Arial", 20), background="white",).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window8, text="India", font=("Arial", 20), background="white", command=partial(selection, 1)).pack(
        anchor=NW)
    R3 = Radiobutton(window8, text="China", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window8, text="Korea", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowG():
    ...
    R1 = Radiobutton(window7, text="Europe", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window7, text="South East Asia", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window7, text="Mexico", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window7, text="Italy", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowF():
    ...
    R1 = Radiobutton(window6, text="papayas, broccoli, tomatoes, kale", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window6, text="Milk, eggs, butter, cheese, cream", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window6, text="Sugar, Sugar cane", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window6, text="tomatoes, brinjal, potatoes", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowE():
    ...
    R1 = Radiobutton(window5, text="papayas", font=("Arial", 20), background="white").pack(
        anchor=NW)
    R2 = Radiobutton(window5, text="eggs", font=("Arial", 20), command=partial(selection, 1)).pack(anchor=NW)
...
def windowD():
    ...
    R1 = Radiobutton(window4, text="Mexico", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window4, text="Brazil", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window4, text="Hawaii", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowC():
    ...
    R1 = Radiobutton(window3, text="Canada", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window3, text="Ethiopia", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window3, text="Turkey", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window3, text="Denmark", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowB():
    ...
    R1 = Radiobutton(window2, text="Canada", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window2, text="Mexico", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
...
def windowA():
    ...
    R1 = Radiobutton(window1, text="Vitamin A", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window1, text="Vitamin C", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
...
def Questions():
    ...
    lbl1 = Label(window11, text="Q.1 Which is the national food of India?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window11, text="Roti", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window11, text="Khichdi", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window11, text="Dal", font=("Arial", 20), background="white",).pack(anchor=NW)
    R4 = Radiobutton(window11, text="Curry", font=("Arial", 20), background="white").pack(anchor=NW)
