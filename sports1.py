...
def windowI():
    ...
    R1=Radiobutton(window9, text="Vishwanathananand", font=("Arial",20),background="White").pack(anchor=NW)
    R2 =Radiobutton(window9, text="Garry kasparov", font=("Arial", 20),background="White").pack(anchor=NW)
    R3 =Radiobutton(window9, text="vladimir kramnink", font=("Arial", 20),background="White").pack(anchor=NW)
...
def windowH():
    ...
    R1 = Radiobutton(window8, text="Boxing", font=("Arial",20),background="white").pack(anchor=NW)
    R2 = Radiobutton(window8, text="Gymnastics", font=("Arial",20),background="white").pack(anchor=NW)
    R3 = Radiobutton(window8, text="Icehockey", font=("Arial",20),background="white").pack(anchor=NW)
...
def windowE():
    ...
    R1=Radiobutton(window5,text="India",font=("Arial",20),background="White").pack(anchor=NW)
    R2=Radiobutton(window5,text="Australia",font=("Arial",20),background="White").pack(anchor=NW)
    R3=Radiobutton(window5,text="Newzealand",font=("Arial",20),background="White",
    command=partial(selection, 1)).pack(anchor=NW)
    R4=Radiobutton(window5,text="England",font=("Arial",20),background="White").pack(anchor=NW)
...
def windowD():
    ...
    command=partial(selection, 1)).pack(anchor=NW)
    R2=Radiobutton(window4,text="Bahadur Singh Chauhan",font=("Arial",20),background="White").pack(anchor=NW)
    R3=Radiobutton(window4,text="Kamaljeet Sandhu",font=("Arial",20),background="White").pack(anchor=NW)
    R4=Radiobutton(window4,text="Harmanpreet singh",font=("Arial",20),background="White").pack(anchor=NW)
...
def windowA():
    ...
    R1=Radiobutton(window1,text="Manchester united",font=("Arial",20),background="White").pack(anchor=NW)
    R2=Radiobutton(window1,text="Liverpool",font=("Arial",20),background="White").pack(anchor=NW)
    R3=Radiobutton(window1,text="Real Madrid",font=("Arial",20),background="White",
    command=partial(selection, 1)).pack(anchor=NW)
    R4=Radiobutton(window1,text="Montevideo Wanderers",font=("Arial",20),background="White").pack(anchor=NW)
...
def Questions():
    ...
    lbl1=Label(window11,text="Q.1 Where were the 2002 worldcup fnals held?",
    font=("Arial",25),background="cyan",compound=LEFT).pack()

    R1=Radiobutton(window11,text="Japan and Korea",font=("Arial",20),background="White",
    command=partial(selection, 1)).pack(anchor=NW)
    R2=Radiobutton(window11,text="Germany",font=("Arial",20),background="White").pack(anchor=NW)
    R3=Radiobutton(window11,text="Scotland",font=("Arial",20),background="White").pack(anchor=NW)
    R4=Radiobutton(window11,text="Colombia",font=("Arial",20),background="White").pack(anchor=NW)
