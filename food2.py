...
def windowI():
    ...
    R1 = Radiobutton(window9, text="USA", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window9, text="India", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window9, text="China", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window9, text=" Korea", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowH():
    ...
    R1 = Radiobutton(window8, text="Vitamin A", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window8, text="Vitamin C", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window8, text="Vitamin D", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window8, text="Vitanin B", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowG():
    ...
    R1 = Radiobutton(window7, text="papaya", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window7, text="milk,egg", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window7, text="Beans", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window7, text="carrots", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowF():
    ...
    R1 = Radiobutton(window6, text="Karnataka", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window6, text="Himachal Pradesh", font=("Arial", 20), background="white",
                     command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window6, text="Bihar", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window6, text="Uttar pradesh", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowD():
    ...
    R1 = Radiobutton(window4, text="Canada", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window4, text="Mexico", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window4, text="Italy", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window4, text="India", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowC():
    ...
    R1 = Radiobutton(window3, text="Roti", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window3, text="Khichdi", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window3, text="Dosa", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window3, text="Upma", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowB():
    ...
    R1 = Radiobutton(window2, text="Canada", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window2, text="Ethiopia", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window2, text="Italy", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window2, text="India", font=("Arial", 20), background="white").pack(anchor=NW)
...
def windowA():
    ...
    R1 = Radiobutton(window1, text="China", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window1, text="South East Asia", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window1, text="USA", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window1, text="Pakistan", font=("Arial", 20), background="white").pack(anchor=NW)
...
def Questions():
    ...
    lbl1 = Label(window11, text="Q.1 Where did the pineapple originate from?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window11, text="India", font=("Arial", 20), background="white").pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window11, text="Brazil", font=("Arial", 20), background="white",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window11, text="Denmark", font=("Arial", 20), background="white").pack(anchor=NW)
    R4 = Radiobutton(window11, text="China", font=("Arial", 20), background="white").pack(anchor=NW)
