...
def windowI():
    ...
    lbl = Label(window9, text="Q.10 Which river is the fastest flowing river in the world?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window9, text="Amazon", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window9, text="Congo", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window9, text="Brahamputra", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window9, text="Nile", font=("Arial", 20), background="White")
...
def windowG():
    ...
    lbl = Label(window7, text="Q.8 Russia has how many time zones?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window7, text="1", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window7, text="11", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window7, text="3", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window7, text="10", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowD():
    ...
    lbl = Label(window4, text="Q.5 Dead sea is located between which two countries?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window4, text="Jorden and Israel", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window4, text="Jorden and Sudan", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window4, text="Isreal and UAE", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window4, text="UAE and Egypt", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window4)
    label.pack()
...
def windowC():
    ...
    R1 = Radiobutton(window3, text="Atlantic Ocean", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window3, text="Pacific Ocean", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window3, text="Indian Ocean", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window3, text="Arctic Ocean", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowB():
    ...
    lbl = Label(window2, text="Q.3 Which city in India is know as 'Scotland of India'?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window2, text="Coorg", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window2, text="Darjelling", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window2, text="Mumbai", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window2, text="Assam", font=("Arial", 20), background="White").pack(anchor=NW)
...
def Questions():
    ...
    lbl = Label(window11, text="Q.1 Which continent is refered as country?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window11, text="Australia", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window11, text="Africa", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window11, text="Asia", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window11, text="Europe", font=("Arial", 20), background="White").pack(anchor=NW)
