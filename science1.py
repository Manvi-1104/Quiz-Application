...
def windowI():
    ...
    R1 = Radiobutton(window9, text="405kg", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window9, text="850kg", font=("Arial", 20), background="White",  command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window9, text="800kg", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window9, text="600kg", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window9)
    label.pack()
...
def windowG():
    ...
    lbl = Label(window7, text="Q.8 Depth of the ocean is measured by an instrument called ?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window7, text="Fathometer", font=("Arial", 20), background="White", command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window7, text="Lectometer", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window7, text="Photometer", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window7, text="Monometer", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window7)
    label.pack()
...
def windowE():
    ...
    R1 = Radiobutton(window5, text="Force", font=("Arial", 20), background="White",  command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window5, text="Energy", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window5, text="Distance", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window5, text="Displacement", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window5)
    label.pack()
...
def windowD():
    ...
    lbl = Label(window4, text="Q.5 Which is the vertibrate the has two chambered heart?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window4, text="Fish", font=("Arial", 20), background="White",  command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window4, text="Snake", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window4, text="Blue Whale", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window4, text="Crocodile", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window4)
    label.pack()
...
def windowC():
    ...
    lbl = Label(window3, text="Q.4 Which is the smallest flightless bird?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window3, text="Rhea", font=("Arial", 20), background="White",  command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window3, text="Kiwi", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window3, text="Penguin", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window3, text="Ostrich", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window3)
    label.pack()
...
def windowB():
    ...
    lbl = Label(window2, text="Q.3 The number of ribs in human body is?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window2, text="23", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window2, text="24", font=("Arial", 20), background="White",  command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window2, text="25", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window2, text="22", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window2)
    label.pack()
...
def windowA():
    ...
    lbl = Label(window1, text="Q.2 The process of preparing food in plants is called as", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window1, text="transpiration", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window1, text="photosynthesis", font=("Arial", 20), background="White", command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window1, text="respiration", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window1, text="physiology", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window1)
    label.pack()
...
def Questions():
    ...
    lbl = Label(window11, text="Q.1 What is the life span of RBC?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window11, text="115 days", font=("Arial", 20), background="White",  command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window11, text="110 days", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window11, text="100 days", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window11, text="120 days", font=("Arial", 20), background="White").pack(anchor=NW)
