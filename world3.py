...
def windowH():
    ...
    lbl = Label(window8, text="Q.9 Russia has how many time zones?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window8, text="1", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window8, text="11", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window8, text="3", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window8, text="10", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowG():
    ...
    R1 = Radiobutton(window7, text="Hawaii", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window7, text="Norway", font=("Arial", 20), background="White", command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window7, text="Iceland", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window7, text="Detroit", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowE():
    ...
    lbl = Label(window5, text="Q.6 Dead sea is located between which two countries?", font=("Arial", 25), background="cyan",
            compound=LEFT).pack()
    R1 = Radiobutton(window5, text="Jordan and Israel", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window5, text="Jordan and Sudan", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window5, text="Israel and UAE", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window5, text="UAE and Egypt", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowB():
    ...
    lbl = Label(window2, text="Q.3 Which country's ancient name is Mesopotamia?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window2, text="Bahrain", font=("Arial", 20), background="White").pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window2, text="Iraq", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    R3 = Radiobutton(window2, text="Iran", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window2, text="Israel", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowA():
    ...
    lbl = Label(window1, text="Q.2 Which city in India is know as 'Scotland of India'?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window1, text="Coorg", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window1, text="Darjelling", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window1, text="Mumbai", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window1, text="Assam", font=("Arial", 20), background="White").pack(anchor=NW)
...
def Questions():
    ...
    lbl = Label(window11, text="Q.1 The Bermuda Triangle is located in which ocean?", font=("Arial", 25), background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window11, text="Atlantic Ocean", font=("Arial", 20), background="White",command=partial(selection, 1)).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window11, text="Pacific Ocean", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window11, text="Indian Ocean", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window11, text="Arctic Ocean", font=("Arial", 20), background="White").pack(anchor=NW)
