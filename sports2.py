...
def windowI():
    ...
    R1=Radiobutton(window9, text="Germany", font=("Arial",20),background="White").pack(anchor=NW)
    R2 =Radiobutton(window9, text="Colombia", font=("Arial", 20),background="White").pack(anchor=NW)
    R3 =Radiobutton(window9, text="Scotland", font=("Arial", 20),background="White").pack(anchor=NW)
...
def windowH():
    ...
    R1 = Radiobutton(window8, text="Manchester united", font=("Arial", 20), background="White").pack(anchor=NW)
    R2 = Radiobutton(window8, text="Liverpool", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window8, text="Real Madrid", font=("Arial", 20), background="White",
                     command=partial(selection, 1)).pack(anchor=NW)
    R4 = Radiobutton(window8, text="Montevideo Wanderers", font=("Arial", 20), background="White").pack(anchor=NW)
    label = Label(window8)
    label.pack()
...
def windowG():
    ...
    R1=Radiobutton(window7,text=2005,font=("Arial",20),background="White").pack(anchor=NW)
    R2=Radiobutton(window7,text=2017,font=("Arial",20),background="White",
    command=partial(selection, 1)).pack(anchor=NW)
    R3=Radiobutton(window7,text=2016,font=("Arial",20),background="White").pack(anchor=NW)
    R4=Radiobutton(window7,text=2010,font=("Arial",20),background="White").pack(anchor=NW)
...
def windowF():
    ...
    R1 = Radiobutton(window6, text="Karnataka", font=("Arial", 20), background="White",
                     command=partial(selection, 1)).pack(anchor=NW)
    R2 = Radiobutton(window6, text="Himachal Pradesh", font=("Arial",20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window6, text="Maharahstra", font=("Arial",20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window6, text="Delhi", font=("Arial",20), background="White").pack(anchor=NW)
...
def windowE():
    ...
    R1 = Radiobutton(window5, text="Milkha Singh", font=("Arial", 20), background="White",
                     command=partial(selection, 1)).pack(anchor=NW)
    R2 = Radiobutton(window5, text="Bahadur Singh Chauhan", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window5, text="Kamaljeet Sandhu", font=("Arial", 20), background="White").pack(anchor=NW)
    R4 = Radiobutton(window5, text="Harmanpreet singh", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowD():
    ...
    R1 = Radiobutton(window4, text="India", font=("Arial", 20), background="White").pack(anchor=NW)
    R2 = Radiobutton(window4, text="Australia", font=("Arial", 20), background="White").pack(anchor=NW)
    R3 = Radiobutton(window4, text="Newzealand", font=("Arial", 20), background="White",
                     command=partial(selection, 1)).pack(anchor=NW)
    R4 = Radiobutton(window4, text="England", font=("Arial", 20), background="White").pack(anchor=NW)
...
def windowC():
    ...
    command=partial(selection, 1)).pack(anchor=NW)
    R2=Radiobutton(window3,text="Yuvraj singh",font=("Arial",20),background="White").pack(anchor=NW)
    R3=Radiobutton(window3,text="kireon Pollard",font=("Arial",20),background="White").pack(anchor=NW)
    R4=Radiobutton(window3,text="Stuard Broad",font=("Arial",20),background="White").pack(anchor=NW)
...
def windowB():
    ...
    R1=Radiobutton(window2,text="Babar azam",font=("Arial",20),background="White").pack(anchor=NW)
    R2=Radiobutton(window2,text="Sachin Tendulkar",font=("Arial",20),background="White").pack(anchor=NW)
    R3=Radiobutton(window2,text="Dawid Malan",font=("Arial",20),background="White",
    command=partial(selection, 1)).pack(anchor=NW)
    R4=Radiobutton(window2,text="Virat kohli",font=("Arial",20),background="White").pack(anchor=NW)
...
def windowA():
    ...
    R1 = Radiobutton(window1, text="Boxing", font=("Arial", 20), background="white").pack(anchor=NW)
    R2 = Radiobutton(window1, text="Gymnastics", font=("Arial", 20), background="white").pack(anchor=NW)
    R3 = Radiobutton(window1, text="Icehockey", font=("Arial", 20), background="white").pack(anchor=NW)
...
def Questions():
    ...
    lbl1=Label(window11,text="Q.1 Which chess player has the highest rating in chess ",
    font=("Arial",25),background="cyan",compound=LEFT).pack()

    R1=Radiobutton(window11,text="Magnus Carlsen",font=("Arial",20),background="White",
    command=partial(selection, 1)).pack(anchor=NW)
    R2=Radiobutton(window11,text="Garry Kasparov",font=("Arial",20),background="White").pack(anchor=NW)
    R3=Radiobutton(window11,text="Vishwanathan Anand",font=("Arial",20),background="White").pack(anchor=NW)
    R4=Radiobutton(window11,text="Vladimir Kramnink",font=("Arial",20),background="White").pack(anchor=NW)
